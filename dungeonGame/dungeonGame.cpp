...
void setLoot(){
  ifstream items (fileDirectory + "/loot.txt");
  ifstream materials (fileDirectory+"/material.txt");
  ifstream modifiers (fileDirectory+"/modifier.txt");
